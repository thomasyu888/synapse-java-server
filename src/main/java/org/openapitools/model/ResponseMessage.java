 ...
 */
@ApiModel(description = "JSON schema for a user-readable message describing the response to a request.")
...
public class ResponseMessage   {
   ...
   * @return message
  */
  @ApiModelProperty(value = "a user-readable message describing the response to a request")
